export const metadata = {
  title: "Example: Add a New Feature | Inove AI Framework",
  description: "Step-by-step guide on adding new features to an existing application using Inove AI Framework workflows.",
};
